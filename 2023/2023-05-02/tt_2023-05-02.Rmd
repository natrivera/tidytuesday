...
survey |>
  ...
  coord_polar() +
  geom_point(data=survey_f , aes(x=0,y=0 ) , inherit.aes = FALSE , size = 10 , color='white') +
  geom_text(data=survey_f , aes(x=0,y=0 , label=comma(n)) , inherit.aes = FALSE , size=2.5) +
